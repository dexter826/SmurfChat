...
export default function UserInfo() {
  ...
  const handleOpenArchivedChats = () => {
    setIsArchivedChatsVisible(true);
  };
  ...
  const QuickActionButton = ({
    ...
    const variants = {
      default:
        "border-slate-300 text-slate-700 hover:border-skybrand-500 hover:text-skybrand-600 hover:bg-skybrand-50 dark:border-slate-600 dark:text-slate-200 dark:hover:border-skybrand-400 dark:hover:bg-skybrand-900/20",
      theme:
      ...
      <div className="flex items-center gap-3 mb-4">
        ...
        >
          ...
          <div
            ...
            } h-12 w-12 items-center justify-center rounded-full bg-gradient-to-br from-skybrand-500 to-skybrand-600 text-white ring-2 ring-skybrand-400/50 font-semibold text-lg hover:ring-skybrand-500 transition-all duration-200 hover:scale-105`}
          >
