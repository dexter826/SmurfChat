    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative z-10 w-full max-w-2xl rounded-lg border border-gray-200 bg-white p-5 shadow-xl dark:border-gray-700 dark:bg-slate-900">
        ...
        <div className="space-y-4">
          ...
          <div>
            <label className="mb-1 block text-sm font-medium">Các lựa chọn</label>
            ...
            {options.length < 10 && (
              <button
                ...
                title="Thêm lựa chọn"
              >
                <span className="inline-flex items-center gap-1"><PlusOutlined /> Thêm lựa chọn</span>
              </button>
            )}
          </div>
        </div>
        ...
        <div className="mt-6 flex justify-end gap-2">
          ...
          <button className="rounded-md bg-skybrand-600 px-4 py-2 text-sm font-medium text-white hover:bg-skybrand-700" onClick={handleSubmit} disabled={loading}>
            Tạo Vote
          </button>
        </div>
      </div>
